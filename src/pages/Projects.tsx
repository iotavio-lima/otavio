        ...
        <div className="h-screen overflow-hidden">
          <div className="mt-64 max-[564px]:mt-32 max-w-96">
            <div className="mt-4 px-4">
              ...
              <a href='https://github.com/iotavio-lima/crown-investments' target="_blank" rel="noopener noreferrer" className="flex items-center justify-between border border-[#404040] h-12 w-full px-6 rounded-xl mt-4 bg-[#0D0D0D] text-[#BFBDBA] text-xl hover:border-[#f2f2f2] hover:text-[#f2f2f2] transition duration-300 select-none shadow-[-2px_2px_4px_rgba(0,0,0,0.5)]">
